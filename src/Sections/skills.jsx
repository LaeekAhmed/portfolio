...
<div className="py-40 w-full">
  ...
  >
    ...
    <div className="text-white mx-auto">
        <p className="head1 text-3xl">Tools I've worked with;</p><br /><br />
    </div>

    <div className="grid grid-cols-6 gap-4 p-5 text-center text-white">
      
      <div className="col-span-full">
        <p className="head1 text-3xl">Languages</p><br />
      </div>
      ...
      <div className="col-span-full">
        <p className="head1 text-3xl">Frameworks & Libraries</p><br />
      </div>
      ...
      <div className="col-span-full">
        <p className="head1 text-3xl">General Tools</p><br />
      </div>
      ...
      <div className="col-span-full">
        <p className="head1 text-3xl">Big Data Technologies</p><br />
      </div>
